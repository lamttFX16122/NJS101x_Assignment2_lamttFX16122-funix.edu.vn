...
module.exports.getAnnual = (req, res, next) => {
    ...
    _User
        ...
        .then((user) => {
            ...
            _TimeRecording
                .find({ userId: req.session.user._id, year: parseInt(moment().format("YYYY")) })
                ...
                _TimeRecording
                    ...
                    .then((data) => {
                        if (data) {
                            ...
                            let str_yearMonth = `${fromDate.format("YYYY")}-${fromDate.format("MM").length === 1 ? +"0" + fromDate.format("MM") : fromDate.format("MM")}`;
...
module.exports.removeAnnual = (req, res, next) => {
    ...
    _User
        ...
        .then((user) => {
            _annualLeave = user.annualLeave;
            _Annual
                .findByIdAndDelete(id_removeAnnual)
                .then((result) => {
                    ...
                    user.save((err, doc) => {
                        ...
                        _TimeRecording
                            .updateOne({ _id: result.timeRecordingId }, { $pull: { annuals: { annualId: id_removeAnnual } } })
                            .then((updated) => {
